<template>
    <div>
        <el-input v-model="search.paperName" placeholder="请输入图纸名称" style="width: 180px; margin:10px 5px;  " ></el-input>
        ...
        <el-button type="primary" style="margin:10px 5px; " @click="searchProjectPaper">搜索</el-button>
        <el-dialog title="项目图纸新增" :visible.sync="dialogFormVisible" width="40%">
            <el-form :model="form" status-icon ref="form">
                <el-form-item label="图纸名称" :label-width="formLabelWidth" prop="paperName">
                    <el-input v-model="form.paperName" autocomplete="off" style="width:83%"></el-input>
                </el-form-item>
                <el-form-item label="类型" :label-width="formLabelWidth" prop="type">
                 ...
                 <el-form-item label="项目图纸" :label-width="formLabelWidth" prop="paperUrl">
                        <el-upload
                                class="upload-demo"
        ...
        <el-table
            ...
            <el-table-column
                    label="操作">
                <template slot-scope="scope">
                    <el-button type="text" @click="updateProjectPaper(scope.row)">编辑</el-button>
    ...
    export default {
        ...
        methods: {
            ...
            submit(form){
                ...
                this.api.addProjectPaper(this.form).then(res =>{
                    this.initDatas();
                    this.dialogFormVisible = false;
            ...
            //删除选中
            deleteSelect(row){
                this.api.deleteProjectPaperList(this.multipleSelection).then( res =>{
                    this.$message.success(res.message);
                    this.initDatas();
                }).catch(res =>{
                    this.$message.error(res.message);
            ...
            //删除按钮
            deleteSelects(row){
                this.api.deleteProjectPaperList([row]).then( res =>{
                    this.$message.success(res.message);
                    this.initDatas();
                }).catch(res =>{
                    this.$message.error(res.message);
