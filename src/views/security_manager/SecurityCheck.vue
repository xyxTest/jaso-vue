    ...
    <div>
        ...
        <el-dialog title="质量检查单指派" :visible.sync="dialogMeasureProblemVisible" width="40%">
            <el-form :model="form" status-icon ref="form">
                ...
                <el-form-item label="检查名称" :label-width="formLabelWidth" prop="securityCheckName">
                    <span>{{rectifyform.securityCheckName}}</span>
                </el-form-item>
        ...
        <el-dialog title="安全检查单检查项编辑" :visible.sync="dialogTypeFormVisible" width="30%">
        ...
        <el-dialog title="安全检查单新增" :visible.sync="dialogFormVisible" width="40%">
            <el-form :model="form" status-icon ref="form">
                <el-form-item label="安全检查单名称" :label-width="formLabelWidth" prop="securityCheckName">
                    <el-input v-model="form.securityCheckName" autocomplete="off" style="width:83%"></el-input>
                </el-form-item>
...
<script>
    import securityManager from '../../jaso_api/security_manager.js';
    ...
    export default {
        ...
        methods: {
            ...
            submitAcceptForm(){
                ...
                securityManager.updateSecurityCheck(this.acceptForm).then(res =>{
                    this.initDatas();
            ...
            //整改进度提交
            submitProcessForm(){
                securityManager.setSecurityCheckProcess(this.processform).then(res =>{
                    this.initDatas();
                    this.dialogFormVisible = false;
                    this.$message.success(res.message);
                }).catch(res =>{
            ...
            submitCheckForm(form){
                ...
                securityManager.checkSecurity(this.checkform).then(res =>{
                    this.initDatas();
                    this.dialogFormVisible = false;
                    this.$message.success(res.message);
                }).catch(res =>{
            ...
            submitRectify(rectifyform){
                ...
                debugger
                securityManager.sendRectifyUserList(this.rectifyform).then(res =>{
                    this.initDatas();
                    this.dialogFormVisible = false;
                    this.$message.success(res.message);
                }).catch(res =>{
            ...
            getRectifyUserList(){
                ...
                var companyId=0;
                securityManager.getListByProjectId({"projectId":projectId,"companyId":companyId}).then(res =>{
            ...
            //指派按钮
            setRectifyUser(row){
                this.rectifyform.securityCheckId=row.securityCheckId;
                this.rectifyform.securityCheckName = row.securityCheckName;
                this.dialogMeasureProblemVisible=true;
                this.getRectifyUserList();
            },
            //整改按钮
            setRectifyProcess(row){
                this.processform.securityCheckId=row.securityCheckId;
                this.dialogProcessVisible=true;
            },
            //接受按钮
            setAccept(row){
                this.acceptForm.securityCheckId=row.securityCheckId;
                this.dialogAcceptVisible=true;
            },
            //验收接口
            setCheck(row){
                this.checkform.securityCheckId=row.securityCheckId;
            ...
            getNatureList(){
                var projectId = sessionStorage.getItem("projectId");
                securityManager.getNatureList({"projectId":projectId}).then(res =>{
                    debugger
            ...
            getInformUserList(){
                var projectId = sessionStorage.getItem("projectId");
                securityManager.getAboutUserList({"projectId":projectId}).then(res =>{
                    debugger
            ...
            submit(form){
                ...
                securityManager.addSecurityCheck(this.form).then(res =>{
                    this.initDatas();
                    this.dialogFormVisible = false;
                    this.$message.success(res.message);
                }).catch(res =>{
            ...
            //删除选中
            deleteSelect(row){
                securityManager.deleteSecurityCheckList(this.multipleSelection).then( res =>{
                    this.$message.success(res.message);
                    this.initDatas();
                }).catch(res =>{
                    this.$message.error(res.message);
            ...
            //删除按钮
            deleteSelects(row){
                securityManager.deleteSecurityCheckList([row]).then( res =>{
                    this.$message.success(res.message);
                    this.initDatas();
                }).catch(res =>{
                    this.$message.error(res.message);
            ...
            initDatas(){
               securityManager.getSecurityCheckList({
                    'pageVo':{
