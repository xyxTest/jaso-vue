        ...
        <el-dialog title="轮播图片新增" :visible.sync="dialogFormVisible" width="40%">
            <el-form :model="form" status-icon ref="form">
                <el-form-item label="轮播图片" :label-width="formLabelWidth" prop="imageRotationUrl">
                    <el-input v-model="form.imageRotationUrl" autocomplete="off" style="width:500px"></el-input>
                </el-form-item>
                <el-form-item label="链接地址" :label-width="formLabelWidth" prop="imageRotationUrl">
                    <el-input v-model="form.imageRotationLinkUrl" autocomplete="off" style="width:500px"></el-input>
                </el-form-item>
            </el-form>
